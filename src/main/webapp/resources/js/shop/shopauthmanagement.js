$(function () {
    ...
    // 列出该店铺下所有授权信息的URL
    var listUrl ='/o2oMaven/shopadmin/listshopauthmapsbyshop?pageIndex=1&pageSize=9999';

    //修改授权信息的URL
    var modifyUrl = '/o2oMaven/shopadmin/modifyshopauthmap';
            ...
            if(data.success){
               ...
               shopauthList.map(function (item,index) {
                   ...
                   if (item.enableStatus == 1){
                       //若状态值为1，标明是授权生效，操作变为删除(即点击删除按钮禁用授权)
                       textOp = "删除";
                       contraryStatus =0;
