$(function() {
    // 获取该店铺下的奖品列表URL
    var listUrl = '/o2oMaven/shopadmin/listawardsbyshop?pageIndex=1&pageSize=9999';
    // 设置奖品的可见状态
    var changeUrl = '/o2oMaven/shopadmin/modifyaward';
    getList();
    function getList() {
        // 访问后台，获取奖品列表
        ...
        .on(
            ...
            function(e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/o2oMaven/shopadmin/awardoperation?awardId='
                    ...
                    window.location.href = '/o2oMaven/frontend/awarddetail?awardId='
                        + e.currentTarget.dataset.id;
                }
            });
    ...
    // 给新增按钮绑定点击事件
    $('#new').click(function() {
        window.location.href = '/o2oMaven/shopadmin/awardoperation';
    });
