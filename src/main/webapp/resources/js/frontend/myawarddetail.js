$(function () {
    ...
    var awardUrl = '/o2oMaven/frontend/getawardbyuserawardid?userAwardId=' + userAwardId;
    ...
    $.getJSON(awardUrl,function (data) {
        if (data.success){
            ...
            if(data.usedStatus ==0){
                imgListHtml += '<div> <img src="/o2oMaven/frontend/generateqrcode4award?userAwardId='
                    + userAwardId
                    + '" width="100%"/></div>';
