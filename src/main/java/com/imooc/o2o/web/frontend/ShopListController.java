...
public class ShopListController {
    ...
    private Map<String,Object> listShopsPageInfo(HttpServletRequest request){
        ...
        if (parentId !=-1){
            ...
            try {
                ...
                ShopCategory parent = new ShopCategory();// ShopCategory类的父类别属性
    ...
    private Map<String,Object> listShops(HttpServletRequest request){
        ...
        if ((pageIndex >-1) && (pageSize >-1)) {
            ...
            //获取组合之后的查询条件
            Shop shopCondition = compactShopCondition4Search(parenId,shopCategoryId,areaId,shopName);
     ...
     * @return
     */
    private Shop compactShopCondition4Search(long parenId, long shopCategoryId, int areaId, String shopName){
        ...
        if (parenId != -1L){
            ...
            parentCategory.setShopCategoryId(parenId);
